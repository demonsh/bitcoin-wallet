...
public class WalletUtilsTest {
    ...
    public void getInterimInheritanceAddress() throws Exception {
        ...
        Address actualAddress = WalletUtils.getInterimInheritanceAddressP2SH(ownerPubKey, heirPubKey, 6);
        ...
        actualAddress = WalletUtils.getInterimInheritanceAddressP2WSH(ownerAddress, heirAddress, 6);
    ...
    public void inheritanceScriptWithCSV() throws Exception {
        ...
        actualRedeemBytes = WalletUtils.inheritanceScriptWithCSV(ownerAddress, heirAddress, 6).getProgram();
